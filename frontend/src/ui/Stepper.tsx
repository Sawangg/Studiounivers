  ...
  return (
    <div className="flex w-full flex-row items-center bg-white-300">
      ...
      <input
        type="number"
        ref={inputRef}
        className="text-md hover:text-black focus:text-black flex w-full items-center bg-white-300 px-4
                    py-4 text-center font-semibold outline-none focus:outline-none"
