...
export const FeatureAbout: React.FC<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>> = () => (
  <section className="flex w-full flex-col md:flex-row">
    <div className="flex w-full flex-col justify-between px-7 pb-10 md:w-1/2 md:px-28 md:pb-16 md:pt-24">
      <div>
        ...
        <p className="text-md text-white-500 md:text-lg">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quasi distinctio vero veniam illum a autem quisquam
          repellendus magni similique earum asperiores non, totam sed minima quibusdam, atque fugit neque doloremque.
          <br />
          <br />
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quasi distinctio vero veniam illum a autem quisquam
          repellendus magni similique earum asperiores non, totam sed minima quibusdam, atque fugit neque doloremque.
