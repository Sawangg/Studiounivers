    ...
    >
        {loading ?
            <div className={`flex justify-center items-center ${loadingStyle}`}>
                <svg role="status" className={`w-8 h-8 animate-spin ${color === "primary" ? "fill-primary-600" : "fill-white-300 group-hover:fill-[#feabb5]"}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
