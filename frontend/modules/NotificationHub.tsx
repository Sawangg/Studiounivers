...
import React, { DetailedHTMLProps, HTMLAttributes, useEffect, useMemo, useRef } from "react";
...
export const NotificationsHub: React.FC<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>> = () => {
    ...
    const transitions = useTransition(notificationsRef.current, {
    ...
    return (
        <div className="fixed w-1/6 flex ml-auto bottom-12 right-12 z-50">
