        ...
        <div className="h-[18rem] relative">
            ...
            <div className="">
                <div className="flex flex-col gap-6">
                    <h2 className="absolute bottom-9 pl-24 text-5xl font-title text-white z-50">Rejoingnez notre newsletter</h2>
                    <p className="">Sign up for our newsletter and receive exclusive offers on new ranges, sales, pop up stores and more</p>
