...
export const TextLink: React.FC<TextLinkProps> = ({ href, className, children, ...props }) => (
  <Link
    className={clsx(
      className,
      "text-zinc-950 underline decoration-zinc-950/50 outline-none hover:decoration-zinc-950 focus:ring-2 focus:ring-blue-500 dark:text-white dark:decoration-white/50 dark:hover:decoration-white",
    )}
    href={href}
    {...props}
  >
