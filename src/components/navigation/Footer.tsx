...
export const Footer: React.FC<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>> = () => (
  <footer className="w-full bg-primary-700 px-4 text-white sm:flex sm:flex-col sm:items-center sm:justify-center sm:px-28">
    <div className="w-full pb-5 pt-9 sm:flex sm:flex-row sm:py-9">
      <div className="flex w-full flex-row flex-wrap sm:w-1/2 sm:flex-nowrap">
        ...
        <div className="mx-auto flex-grow basis-[calc(100%/2)] leading-loose">
          ...
          <Link href="/products">Eclairages</Link> <br />
          <Link href="/products">Accessoires</Link> <br />
          <Link href="/products">Modificateurs</Link> <br />
          <Link href="/products">Arrière-fond</Link> <br />
          <Link href="/products">Lampes</Link> <br />
          <Link href="/products">Appareils Photo</Link> <br />
          <Link href="/products">Strobist</Link> <br />
        </div>
    ...
    <div className="flex w-full flex-row items-center py-6">
      <p className="mx-auto text-base sm:mx-0">Copyright {new Date().getFullYear().toString()} StudioUnivers</p>
